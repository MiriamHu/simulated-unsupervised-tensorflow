...
data_arg.add_argument('--data_set', type=str, default='our')
data_arg.add_argument('--data_dir', type=str, default='data')
data_arg.add_argument('--input_height', type=int, default=302)
data_arg.add_argument('--input_width', type=int, default=160)
...
data_arg.add_argument('--synthetic_image_dir', type=str, default="synthetic")
